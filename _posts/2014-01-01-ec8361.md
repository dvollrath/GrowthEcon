...
1. **IN CLASS**: Create a [CV](/assets/cv_template.tex), in Latex
...
1. **IN CLASS**: Create directories for data and code associated with either (a) your own project or (b) the project I provide
...
1. **IN CLASS/ASSIGN**: Write a data analysis script that incorporates control variables and subroutines to eliminate redundancy. Write a master script that runs the entire process from raw data through analysis.
2. **ASSIGN**: Write a summary of one research paper
